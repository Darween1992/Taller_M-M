...
<body>
    <div class="contenedor-tabla">
        <?php 
            $Id_item=$_GET["Id_item1"];
            $Descrip_item=$_GET["Descrip_item1"];
            $marca=$_GET["Marca1"];
            $Nit_proveedor1=$_GET["Nit_proveedor2"];
                ...
                $consulta="INSERT INTO items(Id_item, Descrip_item, marca, Nit_proveedor1) values('$Id_item','$Descrip_item','$marca','$Nit_proveedor1')";
                ...
                if($resultado==false){
                    ...
                    echo "<table><tr><td>$Id_item</td></tr>";
                    echo "<tr><td>$Descrip_item</td></tr>";
                    echo "<tr><td>$marca</td></tr>";
                    echo "<tr><td>$Nit_proveedor1</td></tr></table>";
   ...
   <footer class="site-footer">
        <div class="contenedor contenedor-footer">
            <nav class="navegacion">
                ...
                <a href="http://localhost/taller/formulario_registro/listado_de_items.php">Lista de Items</a>
            </nav>

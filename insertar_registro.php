...
<body>
    <div class="contenedor-tabla">
        <?php 
            $cod=$_GET["c_art"];
            $nomc=$_GET["Nom_cliente"];
            $apellc=$_GET["Apell_cliente"];
            $telc=$_GET["Tel_cliente"];
            $dirc=$_GET["Dir_cliente"];
                ...
                $consulta="INSERT INTO clientes(CC_Cliente, Nom_cliente, Apell_cliente, Tel_cliente, Dir_cliente) values('$cod','$nomc','$apellc','$telc','$dirc')";
                ...
                if($resultado==false){
                    ...
                    echo "<tr><td>$nomc</td></tr>";
                    echo "<tr><td>$apellc</td></tr>";
                    echo "<tr><td>$telc</td></tr>";
                    echo "<tr><td>$dirc</td></tr></table>";
   ...
   <footer class="site-footer">
        <div class="contenedor contenedor-footer">
            <nav class="navegacion">
                ...
                <a href="http://localhost/taller/formulario_registro/listado_clientes.php">Lista de Clientes</a>
            </nav>
